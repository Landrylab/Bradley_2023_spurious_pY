...
master_files <- list.files('') # Go to the directory containing all of the kinase master files with the weighted ddE values 
...
p <- p+scale_color_gradient(low=viridis(20)[8], high=viridis(20)[18])
...
ggsave(file='Figure_3g.pdf', plot=p, width=5.75, height=4.0)
